    ...
    <section className="relative pt-32 lg:pt-36">
      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          MOBIX is a France-based electronics company delivering premium smartphones for individuals and businesses. We combine cutting-edge technology, elegant design, 
          and dependable performance to provide unmatched value. Experience a future where your communication is smarter, your connectivity is faster, and your mobile lifestyle 
          is more efficient—with MOBIX leading the way.
          </Paragraph>
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="Search your electronics..."
                  className="w-full py-3 outline-none bg-transparent"
                />
                <Button className="min-w-max text-white">
                  <span className="relative z-[5]">Search</span>
                </Button>
              </form>
            </div>
          </div>
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
          <img
            src="https://pbs.twimg.com/media/FViK4NfXEAAbz_B?format=jpg&name=large"
            alt="Hero image"
            width={2350}
            height={2359}
